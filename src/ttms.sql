...
-- Records of employee
-- ----------------------------
INSERT INTO `employee` VALUES ('1', '000001', '张三', '13311111111', '长安南路563-1号', 'zhangsan@163.com');
INSERT INTO `employee` VALUES ('2', '000002', '李四', '13322222222', '莲湖路22号', 'lisi@21cn.com');
INSERT INTO `employee` VALUES ('3', '000003', '王五', '13333333333', '东五路33号', 'wangwu@yeah.net');
INSERT INTO `employee` VALUES ('4', '000004', '刘六', '13344444444', '西一路44号', 'liuliu@sina.com.cn');
INSERT INTO `employee` VALUES ('5', '000005', '郑七', '13355555555', '南稍门55号', 'zhengqi@tom.com');
INSERT INTO `employee` VALUES ('6', '000006', '张三丰', '13366666666', '大溪地66号', '666@xiyou.edu.cn');
INSERT INTO `employee` VALUES ('7', 'test01', '小赵', '13312345678', '长安南路563-1号', 'xiaozhao@163.com');
...
INSERT INTO `employee` VALUES ('10', 'test04', '小胡', '17812345678', '吉祥村65-1号', 'xiaohu@tom.com');
...
CREATE TABLE `user` (
  ...
  `head_path` varchar(500) CHARACTER SET utf8mb4 DEFAULT 'head/default.png' COMMENT '头像路径',
  PRIMARY KEY (`emp_no`),
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('000001', '123456', '1', 'head/default.png');
